...
export default class ListagemConsumoMenor extends Listagem{
    ...
    public async listar(): Promise<void> {
        ...
        while (exec) {
            ...
            switch (opcao) {
                case 1:
                    console.log("Listagem dos 10 Clientes que Menos consumiram produtos em quantidade.");
                    ...
                    consumoProduto.forEach( cliente => {
                        ...
                        console.log('Quantidade de Produtos Consumidos pelo Cliente: ' + cliente.quantidadeProdutos );
                    ...
                    break;
                case 2:
                    console.log("Listagem dos 10 Clientes que Menos consumiram serviços em quantidade.");
                    console.log(`\n---------------------------------------------------------------`);
                    consumoServico.forEach( cliente => {
                        console.log('Nome do Cliente: ' + cliente.nome  );
                        console.log('CPF do Cliente: ' + cliente.cpf  );
                        console.log('Quantidade de Serviços Consumidos pelo Cliente: ' + cliente.quantidadeServicos );
