...
var CadastroCliente = /** @class */ (function (_super) {
    ...
    CadastroCliente.prototype.cadastrar = function () {
        ...
        var num = this.entrada.receberTexto('Informe o número do telefone: ');
        var telefone = new telefone_1.default(ddd, num);
        var numrg = this.entrada.receberTexto('Informe o número do rg: ');
        var datarg = this.entrada.receberTexto('Por favor informe a data de emissão do RG no formato dd/mm/yyyy: ');
        var partesDatarg = data.split('/');
        ...
        var rg = new rg_1.default(numrg, dataEmissaorg);
